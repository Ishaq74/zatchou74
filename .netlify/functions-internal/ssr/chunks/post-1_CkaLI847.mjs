const id = "post-1.md";
						...
						const data = {title:"Titre Article 1 Custom OK",description:"Description custom OK",tags:"Catégorie 1",image:
					...
					,date:new Date(1755993600000),author:{slug:"author-1",collection:"team"},relatedPosts:[{slug:"post-2",collection:"posts"}]};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/Utilisateur/zatchou74/src/content/posts/post-1.md",
							rawData: undefined,
						};
